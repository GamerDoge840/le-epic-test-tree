...
onPrestige(){
    ...
    upgrades: {     
        ...
        34: {
            fullDisplay() {return `<font size="2"><b>[P34] Essence Expansion III</b><font size="1"><br>Unlocks a new row of Essence upgrades.<br>――――――――――――――――――<br>
                Cost: `+format(tmp[this.layer].upgrades[this.id].cost)+` Purity`},        
            unlocked() { return hasUpgrade('Purity', 33) },
            cost: new Decimal(4),
            tooltip() {return "<span style='color:#ffffff'>[P34] Essence Expansion III</span><br>――――――――――――<br><span style='font-size:11px'><span style='color:#FFEB00'>"},
            style() {
                if (hasUpgrade(this.layer, this.id)) return {
                    'background-image': 'radial-gradient(circle at center, #FFE5FA, #E6FCFC)',
                    "width": "155px",
