addLayer("Prestige", {
    ...
    resetDescription: "Reset points, but gain Prestige.<br>―――――――――――<br>",
    ...
    upgrades: {        
        11: {
            fullDisplay() {return `<font size="2"><b>[P11] Begin</b><font size="1"><br>Passively generate 1 Point per second.<br>――――――――――――――――――<br>
        ...
        12: {
            fullDisplay() {return `<font size="2"><b>[P12] Prestige Boost</b><font size="1"><br>Prestige Points boost Point generation.<br>――――――――――――――――――<br>
                Effect:  `+format(upgradeEffect(this.layer, this.id))+`x <br>――――――――――――――――――<br>
                Cost: `+formatWhole(tmp[this.layer].upgrades[this.id].cost)+` Prestige`},        
            unlocked() { return (hasUpgrade("Prestige", 11)) },
            effect() {
              	let eff = player.Prestige.points.plus(2).pow(0.5);
                return eff
            },
            cost: new Decimal(1),
            style() {
        ...
        13: {
            fullDisplay() {return `<font size="2"><b>[P13] Self-Synergy</b><font size="1"><br>Points boost their own generation.<br>――――――――――――――――――<br>
                Effect:  `+format(upgradeEffect(this.layer, this.id))+`x <br>――――――――――――――――――<br>
                Cost: `+formatWhole(tmp[this.layer].upgrades[this.id].cost)+` Prestige`},        
        ...
        22: {
            fullDisplay() {return `<font size="2"><b>[P22] Upgrade Power</b><font size="1"><br>Point generation is faster based on Prestige upgrades bought.<br>――――――――――――――――――<br>
                Effect:  `+format(upgradeEffect(this.layer, this.id))+`x <br>――――――――――――――――――<br>
                Cost: `+formatWhole(tmp[this.layer].upgrades[this.id].cost)+` Prestige`},        
            unlocked() { return (hasUpgrade("Prestige", 21)) },
            effect() {
				let eff = Decimal.pow(1.3, player.Prestige.upgrades.length);
                return eff
            },
            cost: new Decimal(50),
            style() {
        ...
        23: {
            fullDisplay() {return `<font size="2"><b>[P23] Reverse Prestige Boost</b><font size="1"><br>Prestige Point gain is boosted by your points.<br>――――――――――――――――――<br>
                Effect:  `+format(upgradeEffect(this.layer, this.id))+`x <br>――――――――――――――――――<br>
                Cost: `+formatWhole(tmp[this.layer].upgrades[this.id].cost)+` Prestige`},        
