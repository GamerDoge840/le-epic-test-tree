addLayer("Research", {
    ...
    upgrades: {        
     ...
     11: {    
            ...
            fullDisplay() {return `<font size="3"><b>[R01] Boot Systems</b><font size="2"><br>Reactivate and begin to research your surroundings.<br>――――――――――――――――――<br>Currently: `+format(getPointGen()) +`/s<br>――――――――――――――――――<br>Cost: Free`},        
            cost: new Decimal(0),
        ...
        12: {    
            ...
            fullDisplay() {return `<font size="3"><b>[R02] Scan Surroundings</b><font size="2"><br>Increases Research output by 1.5x.<br>――――――――――――――――――<br>Cost: `+format(tmp[this.layer].upgrades[this.id].cost)+` Research`},        
            cost: new Decimal(0.00100),
            currencyInternalName: "points",
        ...
        13: {    
            title: "Scan Plant",
            fullDisplay() {return `<font size="3"><b>[R03] Scan Plant</b><font size="2"><br>Increases Research output by 1.25x.<br>――――――――――――――――――<br>Cost: `+format(tmp[this.layer].upgrades[this.id].cost)+` Research`},        
            cost: new Decimal(0.00250),
            currencyInternalName: "points",
        ...
        14: {    
            title: "Scan Rock",
            fullDisplay() {return `<font size="3"><b>[R04] Scan Rock</b><font size="2"><br>Increases Research output by 1.25x.<br>――――――――――――――――――<br>Cost: `+format(tmp[this.layer].upgrades[this.id].cost)+` Research`},        
            cost: new Decimal(0.00250),
            currencyInternalName: "points",
            branches: ["Research", 12],
            unlocked() {return hasUpgrade("Research", 12)},
        ...
        15: {    
            title: "Scan Cliff",
            fullDisplay() {return `<font size="3"><b>[R05] Scan Cliff</b><font size="2"><br>Increase Research output by 1.10x.<br>――――――――――――――――――<br>Cost: `+format(tmp[this.layer].upgrades[this.id].cost)+` Research`},        
        ...
        16: {    
            title: "Scan Tree",
            fullDisplay() {return `<font size="3"><b>[R06] Scan Tree</b><font size="2"><br>Increase Research output by 1.10x.<br>――――――――――――――――――<br>Cost: `+format(tmp[this.layer].upgrades[this.id].cost)+` Research`},        
            cost: new Decimal(0.004),
            currencyInternalName: "points",
        ...
        17: {    
            title: "Analyze Dirt",
            fullDisplay() {return `<font size="3"><b>[R07] Analyze Dirt</b><font size="2"><br>Increase Research output by 1.15x.<br>――――――――――――――――――<br>Cost: `+format(tmp[this.layer].upgrades[this.id].cost)+` Research`},        
            cost: new Decimal(0.005),
            currencyInternalName: "points",
