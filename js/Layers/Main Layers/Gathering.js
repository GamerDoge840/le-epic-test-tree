addLayer("Gathering", {
    name: "Gathering", // This is optional, only used in a few places, If absent it just uses the layer id.
    symbol: "GATH", // This appears on the layer's node. Default is the id with the first letter capitalized
    ...
    tooltip() {
        let tooltip = "<font size='3'>Gathering<br>――――――――――――<br> <font size='2'><span style='color:#ffffff'> "+format(player.WhitePollen.points)+"/"+format(player.WhitePollen.cap)+" White Pollen</span>"
        return tooltip
    },
        ...
        "Gathering": {
            ...
            content: [
                ["display-text",
                    ...
                    {"font-size": "30px"}],
                    ["display-text",
                        function() {return '('+format(player.WhitePollen.speed.times(20))+'/s)'},
                        {"font-size": "25px"}],
