            ...
            content: ["blank",
                ["display-text",
                    ...
                    ["display-text",
                        ...
                        {"font-size": "25px"}],
                        ["raw-html", function() {if (player.EssenceShards.total.gte(1) || hasUpgrade("Purity", 22)) return '('+format(player.EssenceShards.points)+' Essence Shards)'}, {"color": "#666363", "font-size": "25px"}],
                        ["raw-html", function() {if (player.Purity.total.gte(1)) return '('+format(player.Purity.points)+' Pure Essence)'}, {"color": "#E6FCFC", "font-size": "25px"}],
                        "blank",
                        "blank",
                        ["display-text",
                            function() {return "―――――――――――"},
            ...
            content: ["blank",
                            ["display-text",
                                ...
                                ["display-text",
                                    ...
                                    {"color": "#9d9d9d", "font-size": "37px"}],
                                ["display-text",
                                    function() {return ''+formatWhole(player.Essence.upgrades.length)+' Point Upgrades bought'},
                                    {"font-size": "25px"}],
                                    "blank",
                                ["display-text",
                                    function() {return "―――――――――――"},
