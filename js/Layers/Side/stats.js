            ...
            CurrencyTabs: {
                "Current": {
                    ...
                    ["display-text",
                        ...
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Factory", 1)) return '('+format(player.Factory.watts)+'W)'}, {"color": "#FFF196", "font-size": "25px"}],
                        ["raw-html", function() {if (hasUpgrade("Factory", 1)) return "(+" + format(player.Factory.wattGain) + "W/s)"}, {"color": "#FFF196", "font-size": "17px"}],
                        "blank",
                        ["display-text",
                            function() {return "―――――――――――"},
                            {"color": "#9d9d9d", "font-size": "37px"}],
                ...
                "Best": {
                    ...
                    ["display-text",
                        ...
                        {"color": "#C19A6B","font-size": "25px"}],
                        "blank",
                        ["raw-html", function() {if (hasMilestone("Beans", 0) || player.Money.moneyResetAmount.gte('1')) return '(Highest Bean Level: '+formatWhole(player.BeanLevel.bestBeanLevel)+')'}, {"color": "#F59527", "font-size": "25px"}],
                        "blank",
                        ...
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Factory", 1)) return '(Best Watts: '+format(player.Factory.bestWatts)+'W)'}, {"color": "#FFF196", "font-size": "25px"}],
                        ["display-text",
                            function() {return "―――――――――――"},
                            {"color": "#9d9d9d", "font-size": "37px"}],
