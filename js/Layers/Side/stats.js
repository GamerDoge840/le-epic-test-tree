            ...
            CurrencyTabs: {
                "Current": {
                    ...
                    ["display-text",
                        ...
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Essence", 22)) return '(Level '+formatWhole(player.Level.points)+')'}, {"color": "#D5E5F4", "font-size": "25px"}],
                        "blank",
                ...
                "Best": {
                    ...
                    ["display-text",
                        ...
                        {"color": "#FFFFFF","font-size": "25px"}],
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Essence", 22)) return '(Highest Level: '+formatWhole(player.Level.bestLevel)+')'}, {"color": "#D5E5F4", "font-size": "25px"}],
                        "blank",
