    ...
    microtabs: {
            CurrencyTabs: {
                ...
                "Best": {
                    ...
                    "blank",
                        ["display-text",
                        function() {return '(Best Essence: '+format(player.Essence.bestEssence)+')'},
                        {"color": "#FFFFFF","font-size": "25px"}],
                        "blank",
                        ["raw-html", function() {if (player.Purity.total.gte(1)) return '(Best Purity: '+formatWhole(player.Purity.bestPurity)+')'}, {"color": "#FFE5FA", "font-size": "25px"}],
                        "blank",
                        ["raw-html", function() {if ((hasUpgrade("Essence", 14))) return '――+―― Levels ――+――'}, {"color": "#9d9d9d", "font-size": "37px"}],
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Essence", 14)) return '(Highest Level: '+formatWhole(player.Level.bestLevel)+')'}, {"color": "#D5E5F4", "font-size": "25px"}],
                        "blank",
                        ["raw-html", function() {if ((hasUpgrade("Fruits", 11))) return '――+―― Fruits ――+――'}, {"color": "#9d9d9d", "font-size": "37px"}],
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Fruits", 11)) return '(Best Apples: '+format(player.Fruits.bestApples)+')'}, {"color": "#DA8F81", "font-size": "25px"}],
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Fruits", 11)) return '(Best Pears: '+format(player.Fruits.bestPears)+')'}, {"color": "#C3FA89", "font-size": "25px"}],
                        "blank",
                        ["raw-html", function() {if (hasUpgrade("Fruits", 21)) return '(Best Bananas: '+format(player.Fruits.bestBananas)+')'}, {"color": "#F5EB82", "font-size": "25px"}],
                        "blank",
                        ["display-text",
                            function() {return "―――――――――――"},
                            {"color": "#9d9d9d", "font-size": "37px"}],
