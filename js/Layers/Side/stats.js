            ...
            content: ["blank",
                            ["display-text",
                                ...
                                ["display-text",
                                    ...
                                    {"color": "#9d9d9d", "font-size": "37px"}],
                                    ["display-text",
                                    function() {return ''+formatWhole(player.e.upgrades.length)+'/20 Energy Upgrades bought'},
                                    {"color": "#f4ffd9", "font-size": "25px"}],
                                    "blank",
                                    ["raw-html", function() {if (player.c.chargeResetAmount.gte('1')) return ''+formatWhole(player.c.upgrades.length)+'/20 Charge Upgrades bought'},
