            ...
            content: ["blank",
                ["display-text",
                    ...
                    ["display-text",
                        ...
                        {"font-size": "25px", "color": "#6DB5B2",}],                        "blank",
                        //["display-text",
                        ...
                        ["display-text",
                            ...
                            ["display-text",
                                ...
                                "blank",      
                                ["display-text",
                                    function() {return "You have played this Prestige Tree mod for " + formatTime(player.timePlayed, true + ".")},
                                    {"font-size": "25px"}],  
                                    "blank",
            ...
            content: ["blank",
                            ["display-text",
                                ...
                                ["display-text",
                                    ...
                                    {"color": "#9d9d9d", "font-size": "37px"}],
                                ["display-text",
                                    function() {return ''+formatWhole(player.Research.upgrades.length)+'/8 Researches bought'},
                                    {"color": "#6DB5B2","font-size": "25px"}],
                                    "blank",
